...
/**
 * Main canvas component with smooth zoom and pan functionality:
 * - Buttery smooth 60fps+ zoom using CSS transforms
    ...
    >
      ...
      <div className="absolute bottom-4 right-4 flex items-center space-x-2 bg-white dark:bg-gray-900 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 px-3 py-2">
        ...
        <button 
          ...
          className="ml-2 px-2 py-1 text-xs text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100"
        >
          Reset
        </button>
      </div>
